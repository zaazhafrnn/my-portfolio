    ...
    <div className="bg-white w-full h-full flex flex-col">
      <div className="grid grid-cols-3 gap-8 p-12">
        <div className="flex items-center justify-center">
          <div className="aspect-square w-full max-w-xs rounded-full flex items-center justify-center  overflow-hidden shadow-xl">
            <video
        ...
        <div className="col-span-2 space-y-4">
          ...
          <div className="space-x-4 pt-0">
            <button className="px-2 h-6 bg-neutral-50 text-gray-700 text-sm font-medium rounded-md hover:bg-gray-200 transition-colors border border-gray-300">
              View Resume...
            </button>
            <button className="px-2 h-6 bg-neutral-50 text-gray-700 text-sm font-medium rounded-md hover:bg-gray-200 transition-colors border border-gray-300">
              Contact Info...
